        ...
        <div class="white">
            <div class="br2 pa3 bg-light-blue mb3" style="box-shadow: 0 1px 1px #ccc;">
                <div class="media-body">
                    <div class="f3">
                        <span class="fw6">{{ $user->posts()->where('status', \Platform\Base\Enums\BaseStatusEnum::PUBLISHED)->count() }}</span>
    ...
    <div class="col-md-4">
        <div class="white">
            <div class="br2 pa3 bg-light-red mb3" style="box-shadow: 0 1px 1px #ccc;">
                <div class="media-body">
                    <div class="f3">
                        <span class="fw6">{{ $user->posts()->where('status', \Platform\Base\Enums\BaseStatusEnum::PENDING)->count() }}</span>
    ...
    <div class="col-md-4">
        <div class="white">
            <div class="br2 pa3 bg-light-silver mb3" style="box-shadow: 0 1px 1px #ccc;">
                <div class="media-body">
                    <div class="f3">
                        <span class="fw6">{{ $user->posts()->where('status', \Platform\Base\Enums\BaseStatusEnum::DRAFT)->count() }}</span>
